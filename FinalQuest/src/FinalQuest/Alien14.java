 ...
 * @author Marco Tacca
 */
public class Alien14 extends Alien {
     ...
     */
    public Alien14(int x, int y, String D) {
        super(x, y, D);
        this.direction = 0;
     ...
     */
    public Alien14(int x, int y, String D, int s) {
        super(x, y, D);
        this.direction = 0;
    ...
    private void initAlien() {
        switch (DIFFICULTY) {
            ...
            case "hard":
                ...
                health = 7; // how many times they can be hit before dying
                move_speed += 2; // how fast the alien moves
                missile_speed = (move_speed+3)*-1; // how fast their lasers move
                break;
            case "unforgiving":
                fire_rate = 75;  //how often lasers are fired
                health = 14; // how many times they can be hit before dying
    ...
    public void move() {
        ...
        switch (behavior){
            case "normal":
                ...
                break;
            case "firing":
                if (fire_count%fire_rate == 15)
                {
                    fire();
                }
                else if (fire_count%fire_rate == 30)
                {
                    behavior = "normal";
                }
                break;
    ...
    @Override
    public void fire() {
        missiles.add(new Seeker(x-10, y + height / 2-6, Stage.spaceship));
