 ...
 * @author Marco Tacca
 */
public class UTentacle extends Alien {
    ...
    private void initTentacle() {
        ...
        loadImage("src/resources/utentacles.png");
        getImageDimensions();
        getPlace();
    }
    ...
    public Rectangle getBounds() {
        return new Rectangle(x+30, y, width-60, height-t_height-40);
    }
